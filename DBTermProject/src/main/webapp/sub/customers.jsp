	...
	<div id="wrapper">
		...
		<div id="main">
			...
			<table id="printTable">
				...
				%>
				<tr>
					<td><a onclick="" href="customerDetail.jsp?customer_id=<%=id %>"><%=id%></a>
					<td><a onclick="" href="customerDetail.jsp?customer_id=<%=id %>"><%=name%></a>
					<td><a onclick="" href="customerDetail.jsp?customer_id=<%=id %>"><%=addr%></a>
					<td><a onclick="" href="customerDetail.jsp?customer_id=<%=id %>"><%=web%></a>
					<td><a onclick="" href="customerDetail.jsp?customer_id=<%=id %>"><%=credit%></a>
				</tr>
				<%
					}
